  ...
  const handleSubmit = async (e) => {
    ...
    // --- Client-side Validation ---
     ...
     if (!formData.product_id || !formData.location_id || isNaN(quantityValue) || quantityValue <= 0) {
         setFormError('Por favor, complete todos los campos requeridos con valores válidos (Producto, Ubicación, Cantidad > 0).');
    ...
    try {
        ...
        setFormError(err.message || 'Ocurrió un error inesperado al registrar la entrada.');
         // Removed alert for errors, using formError state instead
    } finally {
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="row g-3 mb-3">
                        ...
                        <div className="col-md-6">
                            <label htmlFor="locationSelect" className="form-label">Ubicación de Destino <span className="text-danger">*</span></label> {/* Added required indicator */}
                            <select
                                className="form-select"
                                id="locationSelect"
                                name="location_id"
                    ...
                    <div className="mb-3">
                        ...
                        <input
                            ...
                            disabled={isSubmitting} // Disable while submitting
                        />
                         <div className="form-text">Ingrese la cantidad a añadir al stock (debe ser mayor a 0).</div>
                    </div>
                     ...
                     <div className="mb-3">
                        ...
                        <input
                            ...
                            disabled={isSubmitting} // Disable while submitting
                        />
                         <div className="form-text">Número de factura, orden de compra, etc.</div> {/* Added helper text */}
                    </div>
                    ...
                    <div className="mb-4"> {/* Increased bottom margin */}
                        ...
                        <textarea
                            ...
                            disabled={isSubmitting} // Disable while submitting
                        ></textarea>
                         <div className="form-text">Detalles adicionales sobre la entrada de inventario.</div> {/* Added helper text */}
                    </div>
